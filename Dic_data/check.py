...
df_link_eng_vn = pd.read_csv("link_eng_vn_gct.csv")
...
common_links.to_csv("link_eng_vn_gct_1.csv", index=False)
unique_links_in_link_eng_vn.to_csv("link_eng_vn_gct_2.csv", index=False)
